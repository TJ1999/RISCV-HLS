<project xmlns="com.autoesl.autopilot.project" name="separated_opt" top="processor" projectType="C/C++">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="separated_opt/src/rv32i.cpp" sc="0" tb="false" cflags="-Iseparated_opt/include" csimflags="" blackbox="false"/>
