...
#pragma HLS RESET variable=_pc
  ...
  i32 imm_B = ((instr >> 7) & 0x1e) | ((instr >> 20) & 0x7e0) | ((instr << 4) & 0x800) | ((instr >> 19) & 0xffff'f000);
  i32 imm_I = (instr >> 20);
  u5 imm_I2 = (instr >> 20) & 0x1f;
  i32 imm_J = ((instr >> 20) & 0x7fe) | ((instr >> 9) & 0x800) | (instr & 0xf'f000) | ((instr >> 11) & 0xfff0'0000);
  ...
  case 0b0100011: {  // Store
    ...
    case 0b000: {  // SB
      ...
      *temp = (*temp & (~mask)) | ((xreg[rs2] & 0xff) << offset);
      break;
    }
    case 0b001: {  // SH
      u32 mask = 0xffff << offset;
      *temp = (*temp & (~mask)) | ((xreg[rs2] & 0xffff) << offset);
      break;
    }
    case 0b010:  // SW
      *temp = xreg[rs2];
