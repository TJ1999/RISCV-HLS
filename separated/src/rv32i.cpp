...
void execute_store(const u32 memory[MEMORY_SIZE], u3 funct3, i32 imm, u1 &error, u32 source1, u32 source2,
...
void execute_arithm(u7 op_code, u3 funct3, u7 funct7, u32 source1, u32 source2, i32 imm, u32 &result, u1 &error, u32 pc,
    u1 &write_reg) {
  write_reg = 1;
  switch (op_code) {
  case 0b011'0111:  // LUI
...
void processor(u32 memory[MEMORY_SIZE], u1 *error) {
...
#pragma HLS RESET variable=g_pc
  ...
  fetch_instruction(memory, g_pc, instr, g_error);
  ...
  case 0b1100011:  // Bxxx
    ...
    break;
  case 0b0000011:
    execute_load(funct3, imm, result, memory, g_error, source1, write_reg);
    break;
  case 0b0100011:
    execute_store(memory, funct3, imm, g_error, source1, source2, write_mem, result, write_addr);
    break;
  default:
    execute_arithm(op_code, funct3, funct7, source1, source2, imm, result, g_error, g_pc, write_reg);
    break;
  }
  write_back(result, rd, g_xreg, memory, imm, write_reg, write_mem, write_addr, branch, g_pc);
  *error = g_error;
}
