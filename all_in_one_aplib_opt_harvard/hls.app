<project xmlns="com.autoesl.autopilot.project" name="all_in_one_aplib_opt_harvard" top="processor" projectType="C/C++">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="all_in_one_aplib_opt_harvard/src/rv32i.cpp" sc="0" tb="false" cflags="-Iall_in_one_aplib_opt_harvard/include" csimflags="" blackbox="false"/>
