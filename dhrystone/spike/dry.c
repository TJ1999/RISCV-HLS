  ...
  CFLAGS="-march=rv32i -mabi=ilp32 -O2 -ffunction-sections -fdata-sections"
  LFLAGS="-nostartfiles -Tlinker_spike.ld"
  
  echo "${CC=cc} -c ${CFLAGS} helper.c -o helper.o"
	      ${CC}    -c ${CFLAGS} helper.c -o helper.o || exit 1

  echo "${CC=cc} -c ${CFLAGS} startup.s -o startup.o"
	${CC}    -c ${CFLAGS} startup.s -o startup.o || exit 1

	echo "${CC=cc} -c ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2"
	      ${CC} -DPASS2 ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2 || exit 1
	echo "${CC=cc} -c -DREG ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c -DREG ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 -DREG ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2r"
	      ${CC} -DPASS2 -DREG ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2r || exit 1
	echo "${CC=cc} -c -O ${CFLAGS} $0 -o dry1.o"
	      ${CC}    -c -O ${CFLAGS} $0 -o dry1.o || exit 1
	echo "${CC} -DPASS2 -O ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2o"
	      ${CC} -DPASS2 -O ${CFLAGS} $0 dry1.o helper.o startup.o ${LFLAGS} -o dry2o || exit 1
	rm -f dry1.o
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  success &= Ch_1_Glob == 'A';
  success &= Ch_2_Glob == 'B';
  success &= Arr_1_Glob[8] == 7;
  success &= Arr_2_Glob[8][7] == NUMBER_OF_RUNS + 10;
  success &= Ptr_Glob->Discr == 0;
  success &= Ptr_Glob->variant.var_1.Enum_Comp == 2;
  success &= Ptr_Glob->variant.var_1.Int_Comp == 17;
  success &= Next_Ptr_Glob->Discr == 0;
  success &= Next_Ptr_Glob->variant.var_1.Enum_Comp == 1;
  success &= Next_Ptr_Glob->variant.var_1.Int_Comp == 18;
  success &= Int_1_Loc == 5;
  success &= Int_2_Loc == 13;
  success &= Int_3_Loc == 7;
  success &= Enum_Loc == 1;
