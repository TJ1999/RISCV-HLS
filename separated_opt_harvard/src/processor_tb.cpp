...
extern u32 g_xreg[32];

void processor_tick_n(unsigned int times, std::vector<u32> &memory, std::vector<u32> &data) {
  g_xreg[31] = 0x1000'0000;  // RAM data starting address
  u1 error = static_cast<u1>(1);
  for (int i = 0; i < times; i++) {
    do_process(memory.data(), data.data(), &error);
  }
  if (error == 1) {
...
int main() {
  ...
  memory = { 0x0004'50b7,  // lui x1, 0x45
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, 0x0004'5000));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x0000'1004));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 8));
  reset_processor();
  ...
  processor_tick_n(4, memory, data);
  assert(check_mem(test_no, data, 0, 123));
  reset_processor();
  ...
  processor_tick_n(4, memory, data);
  assert(check_mem(test_no, data, 0, -2));
  reset_processor();
  ...
  processor_tick_n(4, memory, data);
  assert(check_mem(test_no, data, 0, 124));
  reset_processor();
  ...
  processor_tick_n(4, memory, data);
  assert(check_mem(test_no, data, 0, -1));
  reset_processor();

  // TEST11: Test LB
  test_no++;
  data = { 0, 0x0001'F100 };  // .word
  memory = { 0x005f'8083,  // lb x1, 5(x31)
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, -15));
  reset_processor();

  // TEST12: Test LH
  test_no++;
  data = { 0, 0xFC18'1234 };  // .word
  memory = { 0x006f'9083,  // lh x1, 6(x31)
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, -1'000));
  reset_processor();

  // TEST13: Test LW
  test_no++;
  data = { 0, 0xFFED'2979 };  // .word -1234567
  memory = { 0x004f'a083,  // lw x1, 4(x31)
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, -1'234'567));
  reset_processor();

  // TEST14: Test LBU
  test_no++;
  data = { 0, 0x1234'FF00 };  // .word
  memory = { 0x005f'c083,  // lbu x1, 5(x31)
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, 255));
  reset_processor();

  // TEST15: Test LHU
  test_no++;
  data = { 0, 0xFF00'1234 };  // .word
  memory = { 0x006f'd083,  // lhu x1, 6(x31)
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, 65280));
  reset_processor();
  ...
  memory = { 0x1234'50B7,  // lui	x1, %hi(0x12345678)
      ...
      0x001f'81a3,  // sb x1, 3(x31)
      };
  processor_tick_n(3, memory, data);
  assert(check_mem_byte(test_no, data, 3, 0x78));
  reset_processor();
  ...
  memory = { 0x1234'50B7,  // lui	x1, %hi(0x12345678)
      0x6780'8093,  // addi x1, x1, %lo(0x12345678)
      0x001f'9123,  // sh x1, 2(x31)
      };
  processor_tick_n(3, memory, data);
  assert(check_mem_byte(test_no, data, 2, 0x78));
  assert(check_mem_byte(test_no, data, 3, 0x56));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x12345678));
  reset_processor();
  ...
  processor_tick_n(2, memory, data);
  assert(check_mem(test_no, data, 0, 1234));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x26));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x36));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x10));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x4000'0000));
  reset_processor();

  // TEST26: Test SRLI
  test_no++;
  data = { 0, 0xFF00'0000 };  // -0x01000000
  memory = { 0x004f'a103,  // lw x2, 4(x31)
      0x00C1'5093,  // srli x1, x2, 12
      0x001f'a023,  // sw x1, 0(x31)
      };
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0x000f'f000));
  reset_processor();
  ...
  processor_tick_n(3, memory, data);
  assert(check_mem(test_no, data, 0, 0xffff'f000));
  reset_processor();
  ...
  processor_tick_n(4, memory, data);
  assert(check_mem(test_no, data, 0, 1536));
  reset_processor();
  ...
  test_no++;
  data = { 0, 0xFF00'0000 };  // -0x01000000
  memory = { 0x004f'a183,  // lw x3, 4(x31)
