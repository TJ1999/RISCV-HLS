...
config_export -display_name RISCV_sep_opt_hvd_2 -format ip_catalog -output C:/work/RISCV-HLS/exported_rtls -rtl verilog -vendor TJ -version 1.0.2
source "./separated_opt_harvard/Try2/directives.tcl"
csim_design
csynth_design
cosim_design
